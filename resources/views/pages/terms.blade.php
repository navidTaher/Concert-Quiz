    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="overflow-hidden">
            <div class="p-6 text-white">
                <div class="max-h-[354px] overflow-y-auto border rounded-3xl p-4 bg-secondary">
                    <pre class="whitespace-pre-line text-sm font-bold">
                        ...
                        whether they appear insingular or in plural.
                        ...
                        Agreement) refers to Concert Quiz.
                        ...
                        Terms and Conditions agreement has been created with the help of the Free Terms
                        ...
                        tat any errors or defects can or will be corrected.
